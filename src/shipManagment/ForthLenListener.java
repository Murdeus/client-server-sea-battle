...
public class ForthLenListener implements MouseListener {
	private Field field;

	public ForthLenListener(Field field) {
		this.field = field;
	}
	...
	public void mouseClicked(MouseEvent e) {
		...
		Cell next2 = field.getCellById(button.getXId() + 3, button.getYId());
		if (button.isEnabled() && (next.isEnabled()) && (next1.isEnabled())
			...
			field.getCellById(button.getXId() + 3, button.getYId()).setEnabled(
					false);
			field.getCellById(button.getXId() + 3, button.getYId())
					.setBackground(Color.GREEN);
			//field.getCellById(button.getXId() + 3, button.getYId()).setShip();
			ship.add(field.getCellById(button.getXId() + 3, button.getYId()));
			field.getCellById(button.getXId() + 3, button.getYId()).setShip(ship);
			field.getCellById(button.getXId() + 3, button.getYId()).setHasShip();
			ship.doCopy();
